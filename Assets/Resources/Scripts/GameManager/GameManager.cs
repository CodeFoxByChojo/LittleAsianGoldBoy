...
namespace Chojo.LAG.Manager
{
    ...
    public class GameManager
    {
        ...
        private static readonly GameState gameState = GameState.GetInstance();
        private static readonly Environment environment = Environment.GetInstance();
        private static readonly Character character = Character.GetInstance();
        ...
        {
            if (UIManager.GetInstance().IsPauseScreenActive()) return;
            foreach (var element in hourNotify)
            {
