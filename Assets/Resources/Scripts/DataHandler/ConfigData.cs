namespace Chojo.LAG.DataController
{
    ...
    public class ConfigData
    {
        ...
        {
            get { return knowledgePerHour; }

            set { knowledgePerHour = value; }
        }

        public int LicenseCost
        {
            get { return licenseCost; }

            set { licenseCost = value; }
        }

        public float UpgradeCostIncrease
        {
            get { return upgradeCostIncrease; }
            set { upgradeCostIncrease = value; }
        }
        ...
        {
            get { return botLicenseCost; }

            set { botLicenseCost = value; }
        }

        public int BandwidePrice
        {
            get { return bandwidePrice; }

            set { bandwidePrice = value; }
        }
        ...
        {
            get { return minMotherWaitDuration; }

            set { minMotherWaitDuration = value; }
        }

        public int MaxMotherWaitDuration
        {
            get { return maxMotherWaitDuration; }

            set { maxMotherWaitDuration = value; }
        }

        public int MotherTaskWaitDuration
        {
            get { return motherTaskWaitDuration; }

            set { motherTaskWaitDuration = value; }
        }

        public int MinMotherTaskDuration
        {
            get { return minMotherTaskDuration; }

            set { minMotherTaskDuration = value; }
        }

        public int MaxMotherTaskDuration
        {
            get { return maxMotherTaskDuration; }

            set { maxMotherTaskDuration = value; }
        }

        public int MinBotLifeDuration
        {
            get { return minBotLifeDuration; }

            set { minBotLifeDuration = value; }
        }

        public int MaxBotLifeDuration
        {
            get { return maxBotLifeDuration; }

            set { maxBotLifeDuration = value; }
        }

        public float TimeCycleInSeconds
        {
            get { return timeCycleInSeconds; }

            set { timeCycleInSeconds = value; }
        }

        public int SchoolDuration
        {
            get { return schoolDuration; }

            set { schoolDuration = value; }
        }

        public int MaxComputerLevel
        {
            get { return maxComputerLevel; }

            set { maxComputerLevel = value; }
        }
        ...
        public int GoldPerClick
        {
            ...
            set { goldPerClick = value; }
        }

        public float MaxGoldPrice
        {
            get { return maxGoldPrice; }

            set { maxGoldPrice = value; }
        }

        public float MinGoldPrice
        {
            get { return minGoldPrice; }

            set { minGoldPrice = value; }
        }
        ...
        {
            get { return penalizationDuration; }

            set { penalizationDuration = value; }
        }

        public int BotGoldEarnPerHour
        {
            get { return botGoldEarnPerHour; }

            set { botGoldEarnPerHour = value; }
        }

        public int ClickBaseCost
        {
            get { return clickBaseCost; }

            set { clickBaseCost = value; }
        }

        public int BotKnowledgeCost
        {
            get { return botKnowledgeCost; }

            set { botKnowledgeCost = value; }
        }
